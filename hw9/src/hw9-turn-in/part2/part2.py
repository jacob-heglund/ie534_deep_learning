...
for epoch in range(0,num_of_epochs):
    ...
    print('Epoch: {}/{} ---- Accuracy: {} ---- Runtime: {}'.format(epoch, num_of_epochs, accuracy_epoch,  time.time()-start_time))
    ...
    print('Test Accuracy: {} ---- Runtime: {}'.format(accuracy_test,time.time()-t1))
